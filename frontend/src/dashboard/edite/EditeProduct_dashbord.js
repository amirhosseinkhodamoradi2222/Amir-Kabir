...
function EditeProduct_dashbord() {
  ...
  const getProduct = async () => {
    const res = await axios.get(
      `http://localhost:5000/user/product/${param.id}`
    );
          ...
          <div className="bg-white m-2 p-2 rounded shadow-current">
            ...
            <div className=" w-1/2">
              ...
              <div
                className={
                  images.length >= 1
                    ? "p-1 border-2 border-indigo-600 rounded border-dashed mt-2"
                    : "hidden"
                }
              >
            ...
            <button
              ...
              className="bg-blue-800 text-white w-1/2 py-1 my-4 duration-150 hover:duration-150 hover:bg-blue-600 rounded font-light"
            >
              {" "}
              ویرایش{" "}
            </button>
