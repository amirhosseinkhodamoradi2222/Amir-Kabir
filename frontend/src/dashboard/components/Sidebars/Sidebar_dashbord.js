    ...
    <div className={isOpen ? 'bg-gray-800 text-white relative h-[200vh] w-20 py-4 px-6 flex flex-col' : 'bg-gray-800 text-white relative h-[200vh] w-56 py-4 px-6 flex flex-col'}>
      ...
      <nav className="w-full">
        <ul>
          ...
          <li className="mb-3"><Link className="text-white" to={'/commint_dashbord'}><BsChatText className="inline ml-2" size={25} /></Link><Link to="/commint_dashbord" className={isOpen ? 'hidden' : 'hover:text-blue-400 font-light transition duration-300 no-underline text-white'}> درخواست ها</Link></li>
